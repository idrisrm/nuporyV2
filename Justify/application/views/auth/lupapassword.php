                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="email" value="<?= set_value('email')?>" name="email" type="text" placeholder="Masukan Email">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn btn-block btn-dark">Kirim</button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    log in<a href="<?=base_url('auth')?>" class="text-danger"> disini</a>
                                </div>
                            </div>
                        </form>
                    </div>
