<div class="jumbotron">
    <div class="container">
        <h2>Selamat datang di website Job Placment Center Politeknik Negeri Jember</h2>
        ...
        <p>
            <a class="btn btn-success btn-lg" href="<?php echo site_url("daftar");?>" role="button"><i class="glyphicon glyphicon-briefcase">
            Daftar kerja</i></a>
...
<div class="row">
    ...
    <table class="well table table-bordered">
        ...
        <tr>
            <td colspan="3">
                <a href="<?php echo site_url("pendaftarpekerja/detail/".$pencari->id);?>" class="btn btn-danger btn-sm">
...
<a class="btn btn-primary" href="<?php echo site_url("pendaftarkerja");?>"><i class="glyphicon glyphicon-task"></i> Tampilkan Semua</a>
</div>